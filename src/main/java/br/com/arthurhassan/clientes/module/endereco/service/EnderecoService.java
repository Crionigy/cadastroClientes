package br.com.arthurhassan.clientes.module.endereco.service;
...
@Service
public class EnderecoService extends GenericServiceImpl<Endereco, Long> implements GenericService<Endereco, Long> {
